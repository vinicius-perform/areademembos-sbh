...
export function CreateLessonDialog({ module, open, onOpenChange }: CreateLessonDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[500px] border-white/10 bg-[#050806]/95 backdrop-blur-3xl text-white shadow-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl text-white">Adicionar Aula</DialogTitle>
          <DialogDescription className="text-zinc-400">
            Inserindo nova aula no módulo <span className="text-primary font-medium">{module?.title}</span>.
          </DialogDescription>
        </DialogHeader>
